...
import equipazoTeamImage from './assets/images/equipazo-team.png'
import planCoronaImage from './assets/images/plan-corona-3d.png'
import planRegaloImage from './assets/images/plan-regalo-3d.png'

const AHORRA_PAGE_STYLES =
...
const AHORRA_PAGE_LAYOUT_FIXES = `
          ...
          <section class="equipazo" aria-labelledby="equipazo-title">
            ...
            <div class="equipazo-inner">
              ...
              <div class="equipazo-people">
                <img src="${equipazoTeamImage}" alt="Equipo de Ahorra Sin Líos" loading="lazy" />
            ...
            <div class="plans-container">
              ...
              <div class="plans-cards">
                <article class="plan-card">
                  ...
                  <div class="plan-visual"><img src="${planRegaloImage}" alt="Regalo del Plan Amigo" loading="lazy" /></div>
                ...
                <article class="plan-card dark">
                  ...
                  <div class="plan-visual"><img src="${planCoronaImage}" alt="Corona del Plan Fidelización" loading="lazy" /></div>
