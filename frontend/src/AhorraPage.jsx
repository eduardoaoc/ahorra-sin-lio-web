...
function AhorraPage() {
  ...
  return (
    <>
      <style>{AHORRA_PAGE_STYLES}</style>
      <div className="ahorra-page">
        <div className="ahorra-scope-hero" style={{ fontFamily: APPLE_FONT_STACK }}>
          <main className="hero" aria-labelledby="hero-title">
            <div className="orb one" aria-hidden="true"></div>
            <div className="orb two" aria-hidden="true"></div>
            <div className="energy-wave" aria-hidden="true"></div>

            <div className="hero-inner">
              <header className="header">
                <a href="#" className="brand" aria-label="Ahorra Sin Líos">
                  <img
                ...
                <div className="header-actions">
                  <a className="phone" href="tel:+34900877155">
                    <span>Atención al cliente</span>900 877 155
                  </a>
                  <a className="client-btn" href="#">
                    Área Cliente
                  </a>
                  <button className="menu" type="button" aria-label="Abrir menú">
                    <span></span>
                    <span></span>
                    <span></span>
                  </button>
              ...
              <section className="hero-content">
                <div className="copy">
                  <p className="eyebrow">Ahorro real en energía</p>
                  ...
                  <div className="cta-row" aria-label="Acciones principales">
                    <a className="cta primary" href="#">
                      Comparar mi tarifa <span className="cta-icon">→</span>
                    </a>
                    <a className="cta secondary" href="#">
                      Hablar con un asesor <span className="cta-icon">☎</span>
                    </a>
                  </div>
                </div>

                <div className="visual" aria-hidden="true"></div>
              </section>
        ...
        <div className="ahorra-scope-benefits" style={{ fontFamily: APPLE_FONT_STACK }}>
          <main>
            <section className="benefits-section" aria-labelledby="benefits-title">
              <div className="benefits-container">
                <div className="benefits-top">
                  <div className="benefits-copy">
                    <span className="section-kicker">Vive la energía que mereces</span>
                    <h1 className="benefits-title" id="benefits-title">
                  ...
                  <div className="benefits-list" aria-label="Beneficios principales">
                ...
                <figure
                  ...
                  style={{
                    ...
                    boxShadow:
                      '0 36px 110px rgba(7, 24, 39, 0.14), 0 12px 34px rgba(7, 24, 39, 0.08)',
                    border: '1px solid rgba(255, 255, 255, 0.72)',
                    background:
                      'linear-gradient(145deg, rgba(255,255,255,0.82), rgba(234,252,247,0.92) 48%, rgba(232,247,255,0.96) 100%)',
                  }}
                >
                  <div
                    aria-hidden="true"
                    style={{
                      ...
                      borderRadius: '999px',
                      background:
                        'radial-gradient(circle, rgba(0, 184, 148, 0.28), rgba(0, 184, 148, 0) 72%)',
                      filter: 'blur(24px)',
                      zIndex: 0,
                    }}
                  ></div>
                  <div
                    ...
                    style={{
                      ...
                      transform: 'rotate(8deg)',
                      boxShadow: '0 22px 44px rgba(7, 24, 39, 0.08)',
                      zIndex: 1,
                    }}
                  ></div>
                  <div
                    style={{
                      ...
                      overflow: 'hidden',
                      boxShadow:
                        'inset 0 1px 0 rgba(255,255,255,0.55), 0 26px 56px rgba(7, 24, 39, 0.12)',
                      zIndex: 2,
                    }}
                  >
                  <img
                  ...
                  />
                    <div
                      ...
                      style={{
                        ...
                        inset: 0,
                        background:
                          'linear-gradient(180deg, rgba(255,255,255,0.14), transparent 20%, transparent 74%, rgba(7,24,39,0.2))',
                      }}
                    ></div>
                  </div>
                  <figcaption
                    ...
                    style={{
                      ...
                      boxShadow: '0 18px 44px rgba(7, 24, 39, 0.16)',
                    }}
                  >
        ...
        <div className="ahorra-scope-solutions" style={{ fontFamily: APPLE_FONT_STACK }}>
              ...
              <div className="cards-grid">
                <article className="service-card">
                  ...
                  <div className="card-body">
                    ...
                    <p>
                      Buscamos <span className="highlight">gratis</span> la mejor tarifa para tu
                    ...
                    <div className="service-illustration">
                      <svg viewBox="0 0 120 120" fill="none">
                        ...
                        <path
                          ...
                          strokeLinecap="round"
                        />
                        <path d="M42 50h.1" stroke="#fff" strokeWidth="8" strokeLinecap="round" />
                        <defs>
        ...
        <div
          className="ahorra-scope-clientes-faixa"
          style={{ minHeight: 'auto', display: 'block', fontFamily: APPLE_FONT_STACK }}
        >
          <section className="logo-marquee-section" aria-labelledby="logos-title">
            <div className="marquee-container">
              <h2 className="marquee-title" id="logos-title">
                Ellos ya confían en una energía más simple, ¿te unes?
              </h2>

              <div className="marquee-shell" aria-label="Empresas que confían en Ahorra Sin Líos">
                <div className="marquee-track">
                  <div className="logo-item digitus">
                    <span>
                      <strong className="brand-word">digitus</strong>
                      <span className="brand-sub">podología</span>
                    </span>
                  </div>
                  <div className="logo-item balanza">
                    <span>
                      <strong className="brand-word">Balanza &amp; Asociados</strong>
                    </span>
                  </div>
                  <div className="logo-item marbella">
                    <span>
                      ...
                      <span className="brand-sub">holiday rentals</span>
                    </span>
                  </div>
                  <div className="logo-item fartons">
                    <span>
                      <strong className="brand-word">
                        Fartons
                        <br />
                  ...
                  <div className="logo-item levante">
                    <span>
                      <strong className="brand-word">LU</strong>
                      <span className="brand-sub">Levante</span>
                    </span>
                  </div>
                  <div className="logo-item acuidas">
                    <span>
                      <strong className="brand-word">acuidas</strong>
                      <span className="brand-sub">ayuda a domicilio</span>
                    </span>
                  </div>
                  <div className="logo-item veles">
                    <span>
                      <strong className="brand-word">
                        ◰◰◰
                        <br />
                      ...
                      <span className="brand-sub">Veles e Vents</span>
                    </span>
                  </div>
                  <div className="logo-item huertana">
                    <span>
                      <strong className="brand-word">La Huertana</strong>
                      <span className="brand-sub">1960</span>
                    </span>
                  </div>
                  <div className="logo-item solar">
                    <span>
                      <strong className="brand-word">Solaria</strong>
                      <span className="brand-sub">empresa solar</span>
                    </span>
                  </div>
                  <div className="logo-item nexo">
                    <span>
                      <strong className="brand-word">NEXO</strong>
                      <span className="brand-sub">consulting</span>
                    </span>
                  </div>

                  <div className="logo-item digitus" aria-hidden="true">
                    <span>
                      <strong className="brand-word">digitus</strong>
                      <span className="brand-sub">podología</span>
                    </span>
                  </div>
                  <div className="logo-item balanza" aria-hidden="true">
                    <span>
                      <strong className="brand-word">Balanza &amp; Asociados</strong>
                    </span>
                  </div>
                  <div className="logo-item marbella" aria-hidden="true">
                    <span>
                      <strong className="brand-word">
                        Marbella
                        <br />
                  ...
                  <div className="logo-item fartons" aria-hidden="true">
                    <span>
                      <strong className="brand-word">
                        Fartons
                        <br />
                  ...
                  <div className="logo-item levante" aria-hidden="true">
                    <span>
                      <strong className="brand-word">LU</strong>
                      <span className="brand-sub">Levante</span>
                    </span>
                  </div>
                  <div className="logo-item acuidas" aria-hidden="true">
                    <span>
                      <strong className="brand-word">acuidas</strong>
                      <span className="brand-sub">ayuda a domicilio</span>
                    </span>
                  </div>
                  <div className="logo-item veles" aria-hidden="true">
                    <span>
                      <strong className="brand-word">
                        ◰◰◰
                        <br />
                  ...
                  <div className="logo-item huertana" aria-hidden="true">
                    <span>
                      <strong className="brand-word">La Huertana</strong>
                      <span className="brand-sub">1960</span>
                    </span>
                  </div>
                  <div className="logo-item solar" aria-hidden="true">
                    <span>
                      <strong className="brand-word">Solaria</strong>
                      <span className="brand-sub">empresa solar</span>
                    </span>
                  </div>
                  <div className="logo-item nexo" aria-hidden="true">
                    <span>
                      <strong className="brand-word">NEXO</strong>
                      <span className="brand-sub">consulting</span>
                    </span>
        ...
        <div className="ahorra-scope-como-funciona" style={{ fontFamily: APPLE_FONT_STACK }}>
          <section className="asl-process" aria-labelledby="process-title">
            <div className="wrap">
              <div
                className="media"
              ...
              >
                <div
                  ...
                  style={{
                    ...
                    borderRadius: '38px',
                    background:
                      'radial-gradient(circle at 26% 18%, rgba(255,255,255,0.3), transparent 22%), radial-gradient(circle at 72% 74%, rgba(0,212,126,0.22), transparent 28%), linear-gradient(145deg, rgba(23,42,120,0.22) 0%, rgba(18,200,216,0.16) 48%, rgba(0,184,148,0.24) 100%)',
                    boxShadow: '0 42px 110px rgba(7, 24, 39, 0.16)',
                  }}
                ></div>
                <div
                  aria-hidden="true"
                  style={{
                    ...
                    backdropFilter: 'blur(18px)',
                    transform: 'rotate(10deg)',
                    boxShadow: '0 18px 38px rgba(7, 24, 39, 0.08)',
                    zIndex: 0,
                  }}
                ></div>
                ...
                <div
                  ...
                  style={{
                    ...
                    backdropFilter: 'blur(18px)',
                    boxShadow: '0 34px 86px rgba(7, 24, 39, 0.18)',
                  }}
                >
                  <div
                  ...
                  >
                    <img
                      src={new URL('./simple-process.jpg', import.meta.url).href}
                    ...
                    <div
                      ...
                      style={{
                        ...
                        inset: 0,
                        background:
                          'linear-gradient(180deg, rgba(255,255,255,0.22), transparent 24%, transparent 72%, rgba(7,24,39,0.18))',
                      }}
                    ></div>
                  </div>
                </div>
                <div
                  ...
                  style={{
                    ...
                    backdropFilter: 'blur(18px)',
                    boxShadow: '0 18px 42px rgba(7, 24, 39, 0.12)',
                    color: '#0f4670',
                    fontSize: '13px',
                    fontWeight: 800,
              ...
              <div className="content">
                <p className="kicker">Proceso simple</p>
        ...
        <div className="ahorra-scope-cta" style={{ fontFamily: APPLE_FONT_STACK }}>
          <section className="newsletter" aria-labelledby="newsletter-title">
            <div className="wrap">
              <div className="copy">
                <p className="kicker">Consejos y ahorro</p>
              ...
              >
                <div
                  ...
                  style={{
                    ...
                    borderRadius: '34px',
                    background:
                      'radial-gradient(circle at 28% 18%, rgba(255,255,255,0.5), transparent 20%), linear-gradient(145deg, rgba(23,42,120,0.18) 0%, rgba(18,200,216,0.18) 50%, rgba(0,212,126,0.22) 100%)',
                    boxShadow: '0 38px 96px rgba(7, 24, 39, 0.14)',
                ...
                <div
                  ...
                  style={{
                    ...
                    backdropFilter: 'blur(18px)',
                    boxShadow: '0 18px 40px rgba(7, 24, 39, 0.1)',
                    color: '#0d446f',
                    fontSize: '13px',
                    fontWeight: 800,
                    letterSpacing: '-0.02em',
                ...
                <div
                  ...
                  style={{
                    ...
                    border: '1px solid rgba(255,255,255,0.28)',
                    backdropFilter: 'blur(18px)',
                    boxShadow: '0 34px 90px rgba(7, 24, 39, 0.16)',
                  }}
                >
                  <div
                    style={{
                  ...
                  >
                  <img
                    src={new URL('./woman.jpg', import.meta.url).href}
                    alt=""
                    loading="lazy"
                    style={{
                      position: 'absolute',
                  ...
                  />
                    <div
                      ...
                      style={{
                        ...
                        inset: 0,
                        background:
                          'linear-gradient(180deg, rgba(255,255,255,0.18), transparent 24%, transparent 74%, rgba(7,24,39,0.16))',
                      }}
                    ></div>
                  </div>
                </div>
                ...
                <div
                  ...
                  style={{
                    ...
                    boxShadow: '0 24px 52px rgba(7, 24, 39, 0.12)',
                  }}
                >
                  <strong>Tips claros. Ahorro real.</strong>
                  <span>Recibe contenido útil para entender tu factura.</span>
                </div>
              </div>
            </div>
          </section>
        ...
        <div className="ahorra-scope-resenas" style={{ fontFamily: APPLE_FONT_STACK }}>
          <section className="reviews" aria-labelledby="reviews-title">
            ...
            <div className="summary" aria-label="Resumen de reseñas">
            ...
            <div className="track-wrap" aria-label="Carrusel automático de reseñas">
              <div className="track">
                <article className="review">
                  <div className="top">
                    <div className="avatar">R</div>
                    <div>
                      <h3 className="name">Rubén Marín</h3>
                      <div className="meta">
                ...
                <article className="review">
                  <div className="top">
                    ...
                    <div>
                      <h3 className="name">Susana Cuevas</h3>
                      <div className="meta">
                        <span className="stars">★★★★★</span>
                        <span>hace 2 años</span>
                      </div>
                ...
                <article className="review">
                  <div className="top">
                    ...
                    <div>
                      <h3 className="name">Juan Carlos Guerrero Ramos</h3>
                      <div className="meta">
                        <span className="stars">★★★★★</span>
                        <span>hace 2 años</span>
                      </div>
                ...
                <article className="review">
                  <div className="top">
                    ...
                    <div>
                      <h3 className="name">Cheky Affinito</h3>
                      <div className="meta">
                        <span className="stars">★★★★★</span>
                        <span>hace 2 años</span>
                      </div>
                ...
                <article className="review">
                  <div className="top">
                    ...
                    <div>
                      <h3 className="name">María López</h3>
                      <div className="meta">
                        <span className="stars">★★★★★</span>
                ...
                <article className="review">
                  <div className="top">
                    ...
                    <div>
                      <h3 className="name">Antonio Ruiz</h3>
                      <div className="meta">
                        <span className="stars">★★★★★</span>
                        <span>hace 1 año</span>
                      </div>
                ...
                <article className="review" aria-hidden="true">
                  <div className="top">
                    <div className="avatar">R</div>
                    <div>
                      <h3 className="name">Rubén Marín</h3>
        ...
        <div className="ahorra-scope-form" style={{ fontFamily: APPLE_FONT_STACK }}>
          <section
            className="quote-section"
            aria-labelledby="quote-title"
            style={{ paddingTop: 'clamp(36px, 4vw, 64px)' }}
          >
            <div className="wrap">
              <div className="left-panel">
                <div className="content">
                  <p className="kicker">Oferta personalizada</p>

                  <h2 id="quote-title">Sube tu factura y recibe una oferta en 24 h</h2>
                ...
                <div
                  ...
                  style={{
                    position: 'relative',
                    minHeight: 'clamp(360px, 38vw, 500px)',
                    display: 'grid',
                    placeItems: 'center',
                  }}
                >
                  <div
                    ...
                    style={{
                      ...
                      borderRadius: '38px',
                      background:
                        'radial-gradient(circle at 30% 22%, rgba(255,255,255,0.38), transparent 22%), linear-gradient(145deg, rgba(23,42,120,0.22) 0%, rgba(18,200,216,0.18) 50%, rgba(0,212,126,0.24) 100%)',
                      boxShadow: '0 42px 108px rgba(7, 24, 39, 0.14)',
                    }}
                  ></div>
                  <div
                    aria-hidden="true"
                    style={{
                      ...
                      backdropFilter: 'blur(18px)',
                      transform: 'rotate(-10deg)',
                      boxShadow: '0 18px 40px rgba(7, 24, 39, 0.08)',
                      zIndex: 0,
                    }}
                  ></div>
                  ...
                  <div
                    style={{
                      ...
                      backdropFilter: 'blur(18px)',
                      boxShadow: '0 34px 90px rgba(7, 24, 39, 0.14)',
                    }}
                  >
                    <div
                      style={{
                    ...
                    >
                      <div
                        ...
                        style={{
                          ...
                          borderRadius: '999px',
                          background:
                            'radial-gradient(circle, rgba(0,184,148,0.22), rgba(0,184,148,0) 72%)',
                          filter: 'blur(10px)',
                        }}
                      ></div>
                      ...
                      <div
                        ...
                        style={{
                          ...
                          margin: '32px auto 0',
                          filter: 'drop-shadow(0 24px 38px rgba(15,32,70,0.16))',
                        }}
                      >
                    <img
                      src={new URL('./happy-woman.png', import.meta.url).href}
                      alt=""
                      loading="lazy"
                      style={{
                        width: '100%',
                    ...
                    />
                      ...
                      <div
                        ...
                        style={{
                          ...
                          inset: 0,
                          background:
                            'linear-gradient(180deg, rgba(255,255,255,0.3), transparent 22%, transparent 76%, rgba(7,24,39,0.08))',
                        }}
                      ></div>
                    </div>
                  </div>
                  ...
                  <div
                    ...
                    style={{
                      ...
                      border: '1px solid rgba(255,255,255,0.56)',
                      backdropFilter: 'blur(20px)',
                      boxShadow: '0 18px 46px rgba(7, 24, 39, 0.12)',
                      color: '#124064',
                      fontSize: '13px',
                      fontWeight: 800,
                      letterSpacing: '-0.02em',
                  ...
                  <div
                    ...
                    style={{
                      ...
                      border: '1px solid rgba(255,255,255,0.54)',
                      backdropFilter: 'blur(20px)',
                      boxShadow: '0 18px 46px rgba(7, 24, 39, 0.1)',
                      color: '#124064',
                      fontSize: '13px',
                      fontWeight: 900,
                      letterSpacing: '-0.02em',
        ...
        >
          <footer className="footer" aria-label="Pie de página">
            <div className="footer-main" style={{ paddingBottom: 'clamp(20px, 3vw, 36px)' }}>
              ...
              <nav className="col" aria-label="Empresa">
                <h3>Empresa</h3>
                <ul className="links">
                  <li>
                    <a href="#">Nuestra energía</a>
              ...
              <nav className="col" aria-label="Soporte">
                <h3>Soporte</h3>
                <ul className="links">
                  <li>
